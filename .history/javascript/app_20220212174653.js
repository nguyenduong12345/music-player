...
function inTro() {
  let messages2 = "Hello I'm";
  console.log(`${messages2} ${newName}`);
}
inTro();
//Closure
// function sayHelloFather() {
//   let messages3 = "Hello World";
//   function sayHelloChild() {
//     console.log(messages3);
//   }
//   return sayHelloChild;
// }
// let hello = sayHelloFather();
// hello();

function sayHello1(messages) {
  return function sayHello2(name) {
    console.log(`${messages} ${today is about Closure}`);
  };
}
let hello = sayHello1("Welcome to Javascript");
hello(" ,today is about Closure");
